...
export default function PrivacyPage() {
  return (
    <DocPage eyebrow="Legal" title="Privacy Policy">
      ...
      <p>
        We do not collect payment card details ourselves — billing is handled entirely by Paddle, and Aegis never
      ...
      <p>
        ...
        (your database host, and Paddle for billing where configured), and never across organizations — every row in
